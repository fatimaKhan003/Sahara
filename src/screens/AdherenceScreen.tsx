...
const AdherenceScreen = () => {
  ...
  const renderButton = (label: any) => (
    ...
    >
      <Text
        style={{
          color: period === label ? "#fff" : darkMode ? "#aaa" : "#000",
          fontWeight: "600",
        }}
      >
        {label.toUpperCase()}
  ...
  const pieData = [
    {
      ...
      population: taken,
      color: "#22C55E",
      legendFontColor: darkMode ? "#fff" : "#111",
      legendFontSize: 13,
    },
    {
      name: "Missed",
    ...
    >
      ...
      >
        ...
        >
          ...
          <View style={styles.barBlock}>
            <View style={styles.barHeader}>
              <Text
                style={[styles.barLabel, { color: darkMode ? "#ccc" : "#000" }]}
              >
                Taken
              </Text>

              <Text
                style={[styles.barValue, { color: darkMode ? "#fff" : "#000" }]}
              >
        ...
        <View
          style={[
            styles.insightBox,
            { backgroundColor: darkMode ? "#1E3A8A" : "#ECFEFF" },
          ]}
        >
          <Text
            style={[
